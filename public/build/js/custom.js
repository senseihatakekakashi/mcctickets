...
function init_sidebar() {
    ...
    // Custom Code that Handles the Nav Bar Active Class        
    if(CURRENT_URL.substring(CURRENT_URL.lastIndexOf('/')) == '/create')
        CURRENT_URL = CURRENT_URL.replace('/create','');
    else if(CURRENT_URL.substring(CURRENT_URL.lastIndexOf('/')) == '/edit') {
        CURRENT_URL = CURRENT_URL.replace('/edit','');
        CURRENT_URL = CURRENT_URL.substring(0, CURRENT_URL.lastIndexOf('/'));
    }
    else if(CURRENT_URL.substring(CURRENT_URL.lastIndexOf('/')) == '/setup') {
    ...
    url_lookup.forEach(function (item, index) {                        
        if(CURRENT_URL.substring(CURRENT_URL.lastIndexOf('/')) == '/' + item) {
            CURRENT_URL = CURRENT_URL.replace(item, '');            
            CURRENT_URL = CURRENT_URL.substring(0, CURRENT_URL.lastIndexOf('/'));
        }        
    });    
