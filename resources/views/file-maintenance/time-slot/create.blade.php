            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"></i> Add a new Time Slot</li>
                    </ol>
                    <div class="x_panel">
                        <div class="x_title">  
                            <h2><i class="fa-solid fa-file-circle-plus"></i> Add Time Slot Details</h2>
                        ...
                        <div class="x_content mb-5">
                            <form id="form-time-slot" action="/time-slot" method="POST" novalidate>
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="time" class="form-control" name="time_from" id="time_from" value="{{ old('time_from') }}" required="required" autofocus />
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="time" class="form-control" name="time_to" id="time_to" value="{{ old('time_to') }}" required="required" />
                                    </div>
                                </div>
