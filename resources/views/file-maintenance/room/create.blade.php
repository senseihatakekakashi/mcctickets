            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"></i> Add a new Room</li>
                    </ol>
                    <div class="x_panel">
                        <div class="x_title">  
                            <h2><i class="fa-solid fa-file-circle-plus"></i> Add Room Details</h2>
                        ...
                        <div class="x_content mb-5">
                            <form id="form-room" action="/room" method="POST" novalidate>
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="room_name" id="room_name" value="{{ old('room_name') }}" required="required" autofocus />
                                    </div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="capacity" id="capacity" value="{{ old('capacity') }}" required="required" />
                                    </div>
                                </div>
