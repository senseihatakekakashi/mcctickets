        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="text-right my-5">
                    <a href="room/create" class="btn btn-danger"><i class="fa fa-plus"></i> Add a new Room</a>
                </div>                    
            </div>
                                            ...
                                            <tbody>                                                
                                                @if ($rooms)
                                                    @foreach ($rooms as $room)                                                        
                                                        <tr>
                                                            <td class="p-1 align-middle">{{$room->room_name}}</td>
                                                            <td class="p-1 align-middle">{{$room->capacity}}</td>
                                                            <td class="p-1 align-middle text-center">    
                                                                <a href="room/{{Crypt::encryptString($room->id)}}/edit" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i> Edit</a> 
                                                                <button type="button" class="btn btn-sm btn-warning modal-delete-record-trigger" data-toggle="modal" data-target="#modal-delete" data-button='{"id": "{{Crypt::encryptString($room->id)}}", "room_name" : "{{$room->room_name}}"}' onclick="updateDeleteModalData(this)"><i class="fa fa-trash"></i> Delete</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endif                                                
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">            
                ...
                <div class="modal-body">
                    ...
                    <ul>                        
                        <li><b>Room: </b><span class="modal-room"></span></li>
                    </ul>
                </div>
...
@section('javaScripts')
    ...
    <script>
        ...
        function updateDeleteModalData(args) {
            ...
            $(".modal-room").text(data.room_name);
            $('#form-confirm-delete').attr('action', "room/" + data.id + "/destroy");            
        }
    </script>
@endsection