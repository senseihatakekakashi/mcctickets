            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"></i> Add a new User Role</li>
                    </ol>
                    <div class="x_panel">
                        <div class="x_title">  
                        ...
                        <div class="x_content mb-5">
                            <form id="form-user-role" action="/user-role" method="POST" novalidate>
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="user_role" id="user_role" value="{{ old('user_role') }}" required="required" autofocus />
                                    </div>
                                </div>
