        ...
        <div class="">
            <div class="page-title">
                ...
                <div class="text-right my-5">
                    <a href="user-role/create" class="btn btn-danger"><i class="fa fa-plus"></i> Add a new User Role</a>
                </div>                    
            </div>
                                            ...
                                            <tbody>                                                
                                                @if ($user_roles)
                                                    @foreach ($user_roles as $user_role)                                                        
                                                        <tr>
                                                            <td class="p-1 align-middle">{{$user_role->user_role}}</td>
                                                            <td class="p-1 align-middle text-center">    
                                                                <a href="user-role/{{Crypt::encryptString($user_role->id)}}/edit" class="btn btn-sm btn-dark"><i class="fa fa-edit"></i> Edit</a> 
                                                                <button type="button" class="btn btn-sm btn-warning modal-delete-record-trigger" data-toggle="modal" data-target="#modal-delete" data-button='{"id": "{{Crypt::encryptString($user_role->id)}}", "user_role" : "{{$user_role->user_role}}"}' onclick="updateDeleteModalData(this)"><i class="fa fa-trash"></i> Delete</button>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endif                                                
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">            
                ...
                <div class="modal-body">
                    ...
                    <ul>                        
                        <li><b>User Role: </b><span class="modal-user-role"></span></li>
                    </ul>
                </div>
...
@section('javaScripts')
    ...
    <script>
        ...
        function updateDeleteModalData(args) {
            ...
            $(".modal-user-role").text(data.user_role);
            $('#form-confirm-delete').attr('action', "user-role/" + data.id);            
        }
    </script>
@endsection