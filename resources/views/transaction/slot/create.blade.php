            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"></i> Add a new Slot</li>
                    </ol>
                    <div class="x_panel">
                        <div class="x_title">  
                            <h2><i class="fa-solid fa-file-circle-plus"></i> Add Slot Details</h2>
                        ...
                        <div class="x_content mb-5">
                            <form id="form-slot" action="/slot" method="POST" novalidate>
                                @csrf                                
                                @if ($errors->any())
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="date" class="form-control" name="date" id="date" value="{{ old('date') }}" required="required" autofocus />
                                    </div>
                                </div>
                                        ...
                                        <select class="form-control" name="time_slot" id="time_slot" required>                                                                                        
                                            @if (isset($time_slots))
                                                ...
                                                @foreach ($time_slots as $time_slot)
                                                    ...
                                                    <option value="{{$value}}" {{ (old('time_slot') == $value ? 'selected' : '' ) }}>{{$value}}</option>        
                                                @endforeach
                                            @else
                                        ...
                                        <select class="form-control" name="room_name" id="room_name" required>                                                                                        
                                            @if (isset($rooms))
                                                ...
                                                @foreach ($rooms as $room)
                                                    ...
                                                    @endphp --}}
                                                    <option value="{{$room->room_name}}" {{ (old('room') == $room->room_name ? 'selected' : '' ) }}>{{$room->room_name}}</option>        
                                                @endforeach
                                            @else
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="text" class="form-control capacity" name="fee" id="fee" value="0" disabled/>                                        
                                    </div>
                                </div> 
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input type="text" class="form-control" name="fee" id="fee" value="{{ old('fee') }}" required="required" onkeypress="return isNumberKey(this, event)"/>
                                    </div>
                                </div>
